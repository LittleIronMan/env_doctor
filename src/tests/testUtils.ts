import { DotEnvFile } from "../envHelper";
...
const compare = (a: DotEnvFile, b: DotEnvFile) => (a.filePath > b.filePath) ? 1 : ((b.filePath > a.filePath) ? -1 : 0);

export function equals(whereIsIt: string, arr: DotEnvFile[], brr: DotEnvFile[]) {
    arr.sort(compare);
    brr.sort(compare);
