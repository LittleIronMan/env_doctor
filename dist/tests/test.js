...
var compare = function (a, b) { return (a.filePath > b.filePath) ? 1 : ((b.filePath > a.filePath) ? -1 : 0); };
function equals(arr, brr) {
    arr.sort(compare);
    brr.sort(compare);
...
testUtils_1.runTests([
    {
        ...
        func: function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, envHelper_1.default("src/tests/simpleTest", options)];
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, equals(result, [
                                {
